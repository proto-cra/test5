...
flowchart TD;
    ...
    node3(node3) --> node4(Overview of child and family benefits)
    node4(node4) --> node5(Provincial and territorial programs)
    node2(node2) --> node6(Business registration with the CRA)
    node6(node6) --> node7(Maintain your business)
    node7(node7) --> node8(Bankruptcy/receivership)
    node8(node8) --> node9(Bankruptcy – Business structures)
    node8(node8) --> node10(Bankruptcy)
    node8(node8) --> node11(Proposal in bankruptcy)
    node8(node8) --> node12(Receivership)
    node8(node8) --> node13(Insolvency Intake Centres)
    node7(node7) --> node14(Change of owners, partners, or directors)
    node2(node2) --> node15(Income tax)
    node15(node15) --> node16(Businesses – International and non-resident taxes)
    node16(node16) --> node17(Rendering services in Canada)
    node17(node17) --> node18(Non-resident employer certification)
    node17(node17) --> node19(Where to send international waiver and non-resident employer certification applications)
    node2(node2) --> node20(New page)
    node1(node1) --> node21(Benefits)
    node21(node21) --> node22(Benefits payment dates)
    node1(node1) --> node23(Canada Revenue Agency #40;CRA#41;)
    node23(node23) --> node24(Forms and publications - CRA)
    node24(node24) --> node25(Canada Revenue Agency forms listed by number)
    node25(node25) --> node26(RC342 Request by an Insolvency Practitioner for a Waiver of the Requirement to file a T2 Corporation Income Tax Return under Subsection 220#40;2.1#41; of the Income Tax Act)
    node25(node25) --> node27(RC473 Application for Non-Resident Employer Certification)
    node24(node24) --> node28(Canada Revenue Agency publications listed by number)
    node28(node28) --> node29(B-088 Export Distribution Centre Program)
    node29(node29) --> node30(Export Distribution Centre Program)
    node23(node23) --> node31(Sign in to your CRA account)
    node31(node31) --> node32(CRA Sign in)
    node31(node31) --> node33(Help with using your CRA account)
    node33(node33) --> node34(CRA account help - About Sign-In Partners)
    node33(node33) --> node35(CRA account help - Verify your identity)
    node31(node31) --> node36(Register for a CRA account)
    node23(node23) --> node37(Support from the CRA during difficult situations)
    node37(node37) --> node38(COVID-19 benefits from the CRA)
    node38(node38) --> node39(Validating your application – COVID-19 benefits from the CRA)
    node40(Untitled)
...
GitHub Pages: [https://proto-cra.github.io/test5](https://proto-cra.github.io/test5)
